...
from src.customer_churn.utils.commons import save_object, read_yaml, create_directories
from src.customer_churn.constants import CONFIG_FILE_PATH, PARAMS_FILE_PATH, SCHEMA_FILE_PATH
...
class DataTransformation:
    ...
    def train_val_test_splitting(self):
        try:
            logging.info("[Splitting Started]: Data Splitting process has started")
            ...
            logging.info("[Splitting into sets]: Splitting data into training, validation, and testing sets")
            ...
            logging.info("[Saving]: Saving the training, validation, and testing data in artifacts")
            ...
            logging.info("[Splitting Completed]: Data Splitting process has completed")
    ...
    def initiate_data_transformation(self, X_train, X_val, X_test, y_train, y_val, y_test):
        try:
            logging.info("[Transformation Started]: Data Transformation process has started")
            ...
            logging.info("[Transformation Completed]: Data Transformation process has completed")
