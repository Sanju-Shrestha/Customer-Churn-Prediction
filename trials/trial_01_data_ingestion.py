...
from src.customer_churn.utils.commons import read_yaml, create_directories
from src.customer_churn.constants import *
...
class ConfigurationManager:
    def __init__(self, config_filepath=CONFIG_FILE_PATH, params_filepath=PARAMS_FILE_PATH,schema_filepath=SCHEMA_FILE_PATH):
        '''Initializing Configuration Manger'''
...
class DataIngestion:
    ...
    def import_data_from_mongodb(self):
        ...
        try:
            ...
            logging.info(f'[Initiating]: Data Ingestion from MongoDB Collection {self.config.collection_name}')
            ...
            while True:
                ...
                output_path = os.path.join(self.config.root_dir, 'churndb.csv')
                all_data.to_csv(output_path, index=False)
                logging.info(f'[Data Fetch & Saved]: From MongoDB to {output_path}')
            ...
            logging.error(f'[Error]: Data import issue from MongoDB: {str(e)}')
            raise e
...
if __name__ == "__main__":
    try:
        ...
        logging.info('[Complete]: Data Ingestion from MongoDB Completed!')
    except Exception as e:
