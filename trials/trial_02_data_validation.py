...
if __name__ == "__main__":
    try:
        ...
        if overall_validation_status:
            logging.info("[Validation Successful]: Data Validation Completed Successfully!")
        else:
            logging.info("[Validation Failed]: Data Validation Failed. Check the status file for more details.")

    except Exception as e:
        logging.error(f"[Validation Failed]: Data validation process failed: {e}")
        raise